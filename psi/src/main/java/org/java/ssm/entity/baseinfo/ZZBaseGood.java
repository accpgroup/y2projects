...
public class ZZBaseGood {
	...
	public String toString() {
		return "BaseGood [gdid=" + gdid + ", gdname=" + gdname + ", gdmemcode=" + gdmemcode + ", gdwoocu=" + gdwoocu
				+ ", gdsort=" + gdsort + ", gdtype=" + gdtype + ", gdnorms=" + gdnorms + ", gdunit=" + gdunit
				+ ", gdorigin=" + gdorigin + ", gdmax=" + gdmax + ", gdmin=" + gdmin + ", gdpreprice=" + gdpreprice
				+ ", gdcosprice=" + gdcosprice + ", gdpostfree=" + gdpostfree + ", gdremark=" + gdremark
				+ ", createrid=" + createrid + ", createtime=" + createtime + ", updaterid=" + updaterid
				+ ", updatetime=" + updatetime + ", delstatus=" + delstatus + "]";
	}
