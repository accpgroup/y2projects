...
<script type="text/javascript">
	...
	function tijiao(page) {
		var size=$("sel").val();
		window.location.href="costInfo/goto.do?page="+page;
	}
	
	function tijiao2(size) {
		window.location.href="costInfo/goto.do?size="+size;
	}
...
<body class="no-skin">
								...
								<table id="simple-table"
									...
									<tbody>
										...
										<tr>
											...
											<td class='center'>${k.catouch }</td>
											<td class='center'>${k.caname }</td>
											<td class='center'>${k.caremark }</td>
											<td class="center">
								...
								<div class="page-header position-relative">
									<table style="width: 100%;">
										<tr>
											...
											<a
												class="btn btn-mini btn-success" onclick="add();">新增
											</a>
	...
	<script type="text/javascript">
		...
		//新增
		function add() {
			window.showModalDialog("costInfo/add.do", "", "center=yes;dialogHeight=170px;dialogwidth=410px;location=no;edge=sunken;help=no;resizable=no;status=no;scrollbars=no;");
		...
		function del(id) {
			bootbox.confirm("确定要删除吗?",
					function(result) {
					if(result){
						window.location.href="costInfo/delete.do?id="+id;		
					}
					});
		}
		...
		//修改
		function edit(id) {
			//window.open("costInfo/update.do");
			window.showModalDialog("costInfo/update.do?id="+id, "", "center=yes;dialogHeight=170px;dialogwidth=410px;location=no;edge=sunken;help=no;resizable=no;status=no;scrollbars=no;");
		...
		//导出excel
		function toExcel(size) {
			window.location.href = 'http://localhost:9090/psi/costInfo/excel.do?size='+size;
		}
	</script>
