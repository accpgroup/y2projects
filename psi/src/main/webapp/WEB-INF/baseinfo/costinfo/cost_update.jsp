							...
							<form action="costInfo/update2.do" name="Form" id="Form" method="post">
								...
								<div id="zhongxin" style="padding-top: 13px;">
									<table id="table_report" style="height: 100px"
										...
										<tr>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">费用类别:</td>
											<td>
											<select id="catouch" name="catouch" title="级别" style="width: 98%;">
										...
										<tr>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">费用科目</td>
											<td><input type="text" name="caname" id="WEIXIN"
												value="${bcc.caname }" maxlength="100" placeholder="这里输入费用科目" title="费用科目"
												style="width: 98%;" /></td>
										</tr>
										<tr>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">备注</td>
											<td><input type="text" name="caremark" id="MONEY"
												value="${bcc.caremark }" maxlength="32" placeholder="请输入备注" title="备注"
												style="width: 98%;" /></td>
										</tr>
										<tr>
