					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="costInfo/update2.do" name="Form" id="Form" method="post">
								<input type="hidden" name="bfid" value="${bbk.bfid }"/>
									...
									<table id="table_report" style="height: 100px"
										...
										<tr>
											...
											<td><input type="text" name=bfname id="WEIXIN"
												value="${bbk.bfname }" maxlength="100" placeholder="这里输入账户名称" title="账户名称"
												style="width: 98%;" /></td>
										</tr>
										<tr>
											<td
											...
											<td><input type="text" name="bfcardnum" id="WEIXIN"
												value="${bbk.bfcardnum }" maxlength="100" placeholder="这里输入银行卡号" title="银行卡号"
												style="width: 98%;" /></td>
										</tr>
										<tr>
											<td
											...
											<td><input type="text" name="bfmoney" id="MONEY"
												value="${bbk.bfmoney }" maxlength="32" placeholder="这里输入金额" title="金额"
												style="width: 98%;" /></td>
										</tr>
										<tr>
