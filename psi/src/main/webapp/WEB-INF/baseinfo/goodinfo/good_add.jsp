	...
	<div id="page-wrapper" class="page-loading">
		...
		<div id="page-container" class="sidebar-visible-lg-full">
			...
			<div id="page-content" style="background-color: #FFFFFF;">
				...
				<form action="goodInfo/add2.do" method="post" id="frm"
					class="form-horizontal form-bordered"">
					<input type="hidden" name="delstatus" value="Y"/>
					<div class="block-title">
						<h3>
							&nbsp;&nbsp;&nbsp;&nbsp;<font color="#51D0ED">|新增 |  商品基础信息</font>
						</h3>
					</div>
					<table border="0" width="100%" height="">
						...
						<tr height="50px">
							...
							<td><input type="text" class="form-control"
								placeholder="请输入商品名称" name="gdname"></td>
							<td align="center">助记码</td>
							<td><input type="text" class="form-control"
								placeholder="请输入商品助记码" name="gdmemcode"></td>
						</tr>
						...
						<tr height="50px">
							...
							<td><input type="text" class="form-control"
								placeholder="请输入商品型号" name="gdtype"></td>
							<td align="center">商品规格</td>
							<td><input type="text" class="form-control"
								placeholder="请输入商品规格" name="gdnorms"></td>
						</tr>
						
						<tr height="50px">
							<td align="center">库存上限</td>
							<td><input type="text" class="form-control"
								placeholder="请输入库存上限" name="gdmax"></td>
							<td align="center">库存下线</td>
							<td><input type="text" class="form-control"
								placeholder="请输入库存下线" name="gdmin"></td>
						</tr>
						<tr>
							<td align="center">商品预售价</td>
							<td><input type="text" class="form-control"
								placeholder="请输入商品预售价" name="gdpreprice"></td>
							<td align="center">商品成本价</td>
							<td><input type="text" class="form-control"
								placeholder="请输入商品成本价" name="gdcosprice"></td>
						</tr>
						<tr height="50px">
							<td align="center">供货信息</td>
							<td><input type="text" class="form-control"
								placeholder="请输入供货信息" name="gdpostfree"></td>
							<td align="center">备注</td>
							<td><input type="text" class="form-control"
								placeholder="请输入备注" name="gdremark"></td>
						</tr>
					</table>
					...
					<table border="0" width="70%" height="" style="border-collapse:separate; border-spacing:0px 10px;">
						...
						<tr>
							...
							<td><select id="gunit" name="gdunit"
								class="form-control" data-placeholder="请选择商品单位"
								style="width: 500px;">
							</select></td>
						</tr>
						<tr>
