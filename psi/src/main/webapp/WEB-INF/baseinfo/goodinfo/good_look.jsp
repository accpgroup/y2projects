	...
	<div id="page-wrapper" class="page-loading">
		...
		<div id="page-container" class="sidebar-visible-lg-full">
			<div style="background-color: #EBEEF2;">
				...
				<button class="btn btn-success" onclick="javascript:window.location.href='goodInfo/goto.do'">
			...
			<div id="page-content" style="background-color: #FFFFFF;">
				...
				<form action="page_forms_components.html" method="post"
					...
					<div class="block-title">
						<h3>
							&nbsp;&nbsp;&nbsp;&nbsp;<font color="#51D0ED">| 查看 |  商品基础信息</font>
						</h3>
					</div>
					<table border="0" width="100%" height="">
						...
						<tr height="50px">
							...
							<td><input type="text" class="form-control"
								placeholder="" value='${u.gdname }' readonly="readonly"></td>
							<td align="center">助记码</td>
							<td><input type="text" class="form-control"
								placeholder="" value='${u.gdmemcode }' readonly="readonly"></td>
						</tr>
						...
						<tr height="50px">
							...
							<td><input type="text" class="form-control"
								placeholder="请输入商品型号" value='${u.gdtype }' readonly="readonly"></td>
							<td align="center">商品规格</td>
							<td><input type="text" class="form-control"
								placeholder="请输入商品规格" value='${u.gdnorms }' readonly="readonly"></td>
						</tr>
						
						<tr height="50px">
							<td align="center">库存上限</td>
							<td><input type="text" class="form-control"
								placeholder="" value='${u.gdmax }'readonly="readonly"></td>
							<td align="center">库存下线</td>
							<td><input type="text" class="form-control"
								placeholder="" value='${u.gdmin }' readonly="readonly"></td>
						</tr>
						<tr>
							<td align="center">商品预售价</td>
							<td><input type="text" class="form-control"
								placeholder="" value='${u.gdpreprice }' readonly="readonly"></td>
							<td align="center">商品成本价</td>
							<td><input type="text" class="form-control"
								placeholder="" value='${u.gdcosprice }' readonly="readonly"></td>
						</tr>
						<tr height="50px">
							<td align="center">供货信息</td>
							<td><input type="text" class="form-control"
								placeholder="" value='${u.gdpostfree }' readonly="readonly"></td>
							<td align="center">备注</td>
							<td><input type="text" class="form-control"
								placeholder="" value='${u.gdremark }' readonly="readonly"></td>
						</tr>
					</table>
					...
					<table border="0" width="70%" height="" style="border-collapse:separate; border-spacing:0px 10px;">
						...
						<tr>
							...
							<td><select id="example-chosen" name="example-chosen"
								class="select-chosen" data-placeholder="待填写"
								style="width: 250px;" disabled="disabled">
									<option>${u.gdwoocu }</option>
							</select></td>
						</tr>
						<tr>
