					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="costInfo/update2.do" name="Form" id="Form" method="post">
								...
								<input type="hidden" name="stid" value="${bs.stid }"/>
								<div id="zhongxin" style="padding-top: 13px;">
									<table id="table_report" style="height: 100px"
										class="table table-striped table-bordered table-hover">
										<tr>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">仓库名称</td>
											<td><input type="text" name="stname" id="WEIXIN"
												value="${bs.stname }" maxlength="100" placeholder="这里输入仓库名称" title="仓库名称"
												style="width: 98%;" /></td>
										</tr>
										<tr>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">仓库地址</td>
											<td><input type="text" name="staddress" id="WEIXIN"
												value="${bs.staddress }" maxlength="100" placeholder="仓库地址" title="仓库地址"
												style="width: 98%;" /></td>
										</tr>
										<tr>
											<td
												style="width: 75px; text-align: right; padding-top: 13px;">备注</td>
											<td><input type="text" name="stremark" id="MONEY"
												value="${bs.stremark }" maxlength="32" placeholder="请输入备注" title="备注"
												style="width: 98%;" /></td>
										</tr>
										<tr>
