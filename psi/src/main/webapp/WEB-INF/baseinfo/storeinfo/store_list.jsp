...
<script type="text/javascript">
	...
	function tijiao(page) {
		var size=$("sel").val();
		window.location.href="storeInfo/goto.do?page="+page;
	}
	
	function tijiao2(size) {
		window.location.href="storeInfo/goto.do?size="+size;
	}
...
<body class="no-skin">
								...
								<table id="simple-table"
									...
									<c:forEach items="${ list}" var="k"  varStatus="i">
										<tr>
											...
											<td class='center'>${k.stname }</td>
											<td class='center'>${k.staddress }</td>
											<td class='center'>${k.stremark }</td>
											<td class="center">

												<div class="hidden-sm hidden-xs btn-group">
													<a class="btn btn-xs btn-success" title="编辑"
														onclick="edit('${k.stid}');"> <i
														class="ace-icon fa fa-pencil-square-o bigger-120"
														title="编辑"></i>
													</a> <a class="btn btn-xs btn-danger"
														onclick="del(${k.stid });"> <i
	...
	<script type="text/javascript">
		...
		//新增
		function add() {
			window.showModalDialog("storeInfo/add.do", "", "center=yes;dialogHeight=170px;dialogwidth=410px;location=no;edge=sunken;help=no;resizable=no;status=no;scrollbars=no;");
		...
		function del(id) {
			bootbox.confirm("确定要删除吗?",
					function(result) {
					if(result){
						window.location.href="storeInfo/delete.do?stid="+id+"&isstatus=N";		
					}
					});
		}
		...
		//修改
		function edit(id) {
			window.showModalDialog("storeInfo/update.do?id="+id, "", "center=yes;dialogHeight=170px;dialogwidth=410px;location=no;edge=sunken;help=no;resizable=no;status=no;scrollbars=no;");
		...
		//导出excel
		function toExcel() {
			window.location.href = 'http://localhost:9090/psi/storeInfo/excel.do';
		}
	</script>
