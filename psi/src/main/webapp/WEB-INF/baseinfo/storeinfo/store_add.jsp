					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="costInfo/update2.do" name="Form" id="Form" method="post">
								...
								<input type="hidden" name="isstatus" value="Y"/>
									...
									<table id="table_report" style="height: 100px"
										...
										<tr>
											...
											<td><input type="text" name="stname" id="WEIXIN"
												value="" maxlength="100" placeholder="这里输入仓库名称" title="仓库名称"
												style="width: 98%;" /></td>
										</tr>
										<tr>
											<td
											...
											<td><input type="text" name="staddress" id="WEIXIN"
												value="" maxlength="100" placeholder="仓库地址" title="仓库地址"
												style="width: 98%;" /></td>
										</tr>
										<tr>
											<td
											...
											<td><input type="text" name="stremark" id="MONEY"
												value="" maxlength="32" placeholder="请输入备注" title="备注"
												style="width: 98%;" /></td>
										</tr>
										<tr>
